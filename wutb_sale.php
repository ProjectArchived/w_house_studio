                ...
                <div class="row mb-3">
                  <div class="col-sm-12">
                    ...
                    <?php if($_SESSION['role'] == 8){?>
                        <a href="hdl/wutb.sale.hdl.php?sale_del_id=<?php echo $_GET['sale_edit_id'];?>&date=<?php echo $_GET['date'];?>" class="btn btn-outline btn-danger col-md-3" onclick="return confirm_action()">ລົບລາຍການ</a>
                      </td>
                    <?php } ?>
                      <a href="wutb_sale_detail.php?date=<?php echo $_GET['date'];?>" class="btn btn-outline btn-color col-md-3">ກັບຄືນ</a>
                    </div>
                  </div>   
                </div>
