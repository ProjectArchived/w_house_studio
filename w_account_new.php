            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                  <div class="col-sm-12">
                    <div class="row justify-content-md-end">
                      <button type="submit" class="btn btn-color col-md-3" name="change_password" onclick="return confirm_action()">ປ່ຽນລະຫັດບັນຊີໃໝ່</button>
              ...
              <?php } elseif(!empty($_GET['change_detail'])){
                ...
                <div class="row mb-3">
                  <div class="col-sm-12">
                    <div class="row justify-content-md-end">
                      <button type="submit" class="btn btn-color col-md-3" name="change_detail" onclick="return confirm_action()">ປ່ຽນຂໍ້ມູນບັນຊີໃໝ່</button>
                      <a href="w_account.php" class="btn btn-outline btn-color col-md-3">ກັບຄືນ</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  <div class="col-sm-12">
                    <div class="row justify-content-md-end">
                      <button type="submit" class="btn btn-color col-md-3" name="new_user" onclick="return confirm_action()">ບັນທຶກບັນຊີໃໝ່</button>
                      <a href="w_account.php" class="btn btn-outline btn-color col-md-3">ກັບຄືນ</a>
                    </div>
                  </div>
                </div>
