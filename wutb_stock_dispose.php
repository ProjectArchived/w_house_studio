   ...
   <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title f-header">ລາຍລະອຽດການໂລະເຄື່ອງອອກ</h5>
              ...
              <form method ="post" action="hdl/wutb.stock.hdl.php">
                ...
                <div class="row mb-3">
                  ...
                  <select class="form-select" aria-label="Default select example" name="item_id" required>
                      ...
                      <?php while($row=mysqli_fetch_array($dispose_view)) {?>
                ...
                <div class="row mb-3">
                  <div class="col-sm-12">
                    <div class="row justify-content-md-end">
                      <button type="submit" class="btn btn-color col-md-3" name="new_dispose" onclick="return confirm_action()">ບັນທຶກການໂລະເຄື່ອງອອກ</button>
