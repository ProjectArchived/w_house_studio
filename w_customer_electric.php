          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-lg-12">
                <div class="row">
                  <div class="col-md-4">
                    <h5 class="card-title f-header">ລາຍການຊຳລະຄ່າທຳນຽມ</h5>
                  </div>
                  <div class="col-md-8">
              ...
              <div class="table-responsive">
                <table class="table datatable table-hover table-striped">
                  ...
                  <tbody>
                    ...
                    <?php 
                      while($row = mysqli_fetch_array($view_customer_electric)){?>
                    <tr>
                      ...
                      if(!empty($row['currency'])){
                        ...
                        echo number_format($row['actual_amount']).' '.$currency_result['currency_la'];
                      }?></td>
                      <td><?php 
