   ...
   <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title f-header">ລາຍລະອຽດຄ່າອື່ນໆ</h5>
                ...
                <div class="row mb-3">
                  <div class="col-sm-12">
                    <div class="row justify-content-md-end">
                      <button type="submit" class="btn btn-color col-md-3" name="utility_others" onclick="return confirm_action()">ບັນທຶກຄ່າອື່ນໆ</button>
