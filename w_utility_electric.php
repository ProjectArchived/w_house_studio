            ...
            <div class="card-body">
              ...
              <form method="post" action="hdl/utility.hdl.php" autocomplete="off" >
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="ref_no" placeholder="ເລກທີບິນຄ່າໄຟ" required>
                  </div>
                </div>
                <div class="row mb-3">
                  <label class="col-sm-3 col-form-label">ເລກທີໝໍ້ນັບໄຟ</label>
                  <div class="col-sm-9">
                    <select class="form-select" aria-label="Default select example" name="meter_id" required>
                      <option value="">ກົດເພື່ອເລືອກ</option>
                      <?php while($r_utility_emeter = mysqli_fetch_array($utility_emeter)){ ?>
                        <option value="<?php echo $r_utility_emeter['id'];?>"><?php echo $r_utility_emeter['meter_no'].' - '.$r_utility_emeter['location'];?></option>  
                      <?php } ?>
                    </select>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-3 col-form-label">ພະລັງງານໃຊ້ໃນເດືອນ</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="t_unit" placeholder="ພະລັງງານໃຊ້ໃນເດືອນ" required>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  <div class="col-sm-12">
                    <div class="row justify-content-md-end">
                      <button type="submit" class="btn btn-color col-md-3" name="utility_electric" onclick="return confirm_action()">ບັນທຶກ</button>
