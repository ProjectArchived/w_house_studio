                ...
                <div class="row">
                  ...
                  <div class="col-lg-8">
                    <div class="row justify-content-md-end">
                      ...
                      <?php 
                      $date = $_GET['date'];
                      $check_date = mysqli_query($db, "SELECT * FROM wutb_db_expense WHERE DATE (create_date) = '$date' AND check_by ='' AND cat_id = 6");

                      if(!empty(mysqli_fetch_array($check_date)) && $_SESSION['role'] == 8) {

                          echo '<a href="hdl/wutb.salary.hdl.php?approve_all_rec=';
                          echo $_GET['date'];
                          echo '&user_id=';
                      ...
                      ?>
                      <a href="wutb_salary_main.php"  class="btn btn-outline btn-color btn-in-table p-2 col-md-3">ກັບຄືນ</a>   
                    </div>
                  </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <?php if($_SESSION['role'] == 8 || empty($row['check_by'])){?>
                          <a href="wutb_salary_add.php?salary_edit_id=<?php echo $row['id'];?>&date=<?php echo $_GET['date'];?>" class="table_tbn badge bg-warning text-light" ><i class="bi bi-pencil-fill"></i></a>
                        <?php }?>
                      </td> 
                    </tr>
                    <?php }?>
